...
var fs = require('fs');
var ip = require('ip');
var Service = require('hap-nodejs/lib/Service').Service;
var StreamController = require('hap-nodejs/lib/StreamController').StreamController;
...
function FFMPEG(bridge, ffmpegOpt) {
